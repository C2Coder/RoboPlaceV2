...
try:
    ...
    print(f'Usage ./RoboPlaceV2.py <port> <baud> <window size> <size>')
    #print(f'Or ./snak.py --noserial')
    print(f'Example: ./RoboPlaceV2.py /dev/ttyACM0 115200 800 100')
    exit()
...
def main():
    ...
    pygame.display.set_caption('RoboPlaceV2')
    pygame.font.init()
